...
function dateDifference($date_1 , $date_2 , $differenceFormat = '%r%a' )
{
    ...
    $query = "SELECT * FROM estimation_table WHERE patient_id = '$id' AND model_number = '1' ORDER BY id ASC
                    ";
    ...
    if ($row != NULL) {
        ...
        echo '
            <table class="table table-hover">
                <tbody>
                    <th scope="row"></th>
                    <td>No Data Avalible for Pre-OP Analysis</td>
                    </tr>
                    <tr>
            </tbody>
            </table>
