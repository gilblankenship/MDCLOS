...
<html lang="en">
    ...
    <body>
            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="jumbotron text-center pt-4 pb-4 mb-0" style="background-color:#fff">
                        ...
                        <select class="form-control-lg text-center" id="select_patient" name="patient_select" style="width:auto; background-color:#fff">
                            <option selected disabled value="">Last name, First name</option>
                            <!-- populated by the PHP script -->
                            <?php include './assets/php/patient_overview/fetch_patient_options.php'; ?>
                        </select>
                    </div>
                            ...
                            <div class="modal-body">
                                <form action="./assets/php/patient_overview/insert_supplemental_action.php" method="get">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="new_est" class="col-form-label ">New Est LOS:</label>
                                                <input type="text" class="form-control " id="new_est" name="new_est" placeholder="# Days">
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="./assets/js/patient_overview/update.js"></script>
