                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="container-fluid header p-0" style="height:215px">
                            <div class="overlay"></div>
                                ...
                                <div class="description" >
                                    ...
                                    <h1 class="display-4" style="font-size:40px">All variables</h1>
                                </div>
                    </div>
                    <hr>
                    ...
                    <div class="container">
                            ...
                            <?php
                                ...
                                $query="SELECT question_id, question_body FROM model_questions_table WHERE question_id > 6";
                                $result_set = $mysql->query($query);
                       
                                //question 1
                                $row = $result_set -> fetch_assoc();
                                $ID=$row['question_id'] - 6;
                                $question=$row['question_body'];
                            ?> 
                               <form class="bool_question_2" id="<?php echo "q$ID"?>" data-question="<?php echo $ID?>"> <!-- Form with ID of the form "q1, q2..." and data-question="1,2,3.." -->
                            ...
                            ?> 
                               <form class="bool_question_2" id="<?php echo "q$ID"?>" data-question="<?php echo $ID?>"> <!-- Form with ID of the form "q1, q2..." and data-question="1,2,3.." -->
                                    ...
                                    <div class="button-wrap">
                                        ...
                                        <label for="radio_<?php echo "$ID"?>_1" id="1" class="question_button"><h2 style="width:300px; text-align:center; font-size:28px; font-weight:bold">1</h1></label>
                            ...
                            ?> 
                               <form class="bool_question_2" id="<?php echo "q$ID"?>" data-question="<?php echo $ID?>"> <!-- Form with ID of the form "q1, q2..." and data-question="1,2,3.." -->
                                    ...
                                    <div class="button-wrap">
                                        ...
                                        <label for="radio_<?php echo "$ID"?>_yes" id="yes" name="<?php echo "q$ID"?>" class="question_button"><h1 style="width:300px; text-align:center;font-size:28px; font-weight:bold">Complete Injury</h1></label>                            
                                        ...
                                        <label for="radio_<?php echo "$ID"?>_no" id="no" name="<?php echo "q$ID"?>" class="question_button"><h1 style="width:300px; text-align:center;font-size:28px;font-weight:bold">OTHER</h1></label>
                            ...
                            ?> 
                               <form class="bool_question_2" id="<?php echo "q$ID"?>" data-question="<?php echo $ID?>"> <!-- Form with ID of the form "q1, q2..." and data-question="1,2,3.." -->
                                    ...
                                    <div class="button-wrap">
                                        <input type="radio" id="radio_<?php echo "$ID"?>_yes"  name="<?php echo "q$ID"?>" class="hidden radio-label" style="width:300px;"/></input><!-- Radio button, option YES. name="q1,q2..."-->
                                        <label for="radio_<?php echo "$ID"?>_yes" id="yes" name="<?php echo "q$ID"?>" class="question_button"><h1 style="width:300px; text-align:center; font-size:28px;font-weight:bold">YES</h1></label>
            
                                        <input type="radio"  id="radio_<?php echo "$ID"?>_no"  name="<?php echo "q$ID"?>" class="hidden radio-label" style="width:300px;"/></input> <!-- Radio button, option NO. name="q1,q2..."-->
                                        <label for="radio_<?php echo "$ID"?>_no" id="no" name="<?php echo "q$ID"?>" class="question_button"><h1 style="width:300px; text-align:center; font-size:28px;font-weight:bold">NO</h1></label>
                                    </div>
                                    <br>
                                </form>
                            ...
                            ?> 
                               <form class="bool_question_2" id="<?php echo "q$ID"?>" data-question="<?php echo $ID?>"> <!-- Form with ID of the form "q1, q2..." and data-question="1,2,3.." -->
                                    ...
                                    <br><br>
                                    <div class="button-wrap">
                                        <input type="radio" id="radio_<?php echo "$ID"?>_yes"  name="<?php echo "q$ID"?>" value="1" class="hidden radio-label" style="width:300px;"/></input><!-- Radio button, option YES. name="q1,q2..."-->
                                        <label for="radio_<?php echo "$ID"?>_yes" id="yes" name="<?php echo "q$ID"?>" class="question_button"><h1 style="width:300px; text-align:center;font-size:28px; font-weight:bold">Rehab Center</h1></label>
                                        
                                        <input type="radio"  id="radio_<?php echo "$ID"?>_no"  name="<?php echo "q$ID"?>" value="0" class="hidden radio-label" style="width:300px;"/></input> <!-- Radio button, option NO. name="q1,q2..."-->
                                        <label for="radio_<?php echo "$ID"?>_no" id="no" name="<?php echo "q$ID"?>" class="question_button"><h1 style="width:300px; text-align:center;font-size:28px;font-weight:bold">OTHER</h1></label>
                                    </div>
                                    <br>
                                </form> 
                            ...
                            <br>
                                <form class="move_button"> <!-- Form with ID of the form "q1, q2..." and data-question="1,2,3.." -->
                                    <div class="button-wrap">
                                        ...
                                        <label for="radio_submit" id="submit_2" name="move" class="question_button"><h1 style="width:300px; text-align:center;font-weight:bold">Submit</h1></label>
                                    </div>
                                    <br>
                                </form>
                            <br>
